                ...
                <div class="container home_container">
                    <div class="menu_toggle open">
                        <svg
                            ...
                            height="40"
                            >
                            <use xlink:href="img/defs.svg#hamburger"></use>
                        </svg>
                    </div>
                    <div class="row">
                            ...
                            <div class="home_icons">
                                <a href="mailto: fbabris2@gmail.com" class="home__icons" id="email">
                                    <svg
                                        ...
                                        viewBox="0 0 38 36"
                                        >
                                        <use xlink:href="img/defs.svg#email"></use>
                                    </svg>
                                </a>
                                <a href="https://github.com/fbabris" class="home__icons" id="github">
                                    <svg
                                        ...
                                        viewBox="0 0 35 35"                      
                                        >
                                        <use xlink:href="img/defs.svg#github"></use>
                                    </svg>                    
                                </a>
                                <a href="https://www.linkedin.com/in/filips-babris-6a254b111/" class="home__icons" id="linkedin">
                                    <svg
                                        ...
                                        viewBox="0 0 24 24"
                                        >
                                        <use xlink:href="img/defs.svg#in"></use>
                                    </svg>
                                </a>
                            </div>
                        </div>
    ...
    <section class="section">
        <div class="review_background">
            ...
            <div class="glider-contain">            
                    <template id="review">
                        <div class="col4 review_single" id='randomId'>
                            
                            <div class="text_center">
                                <blockquote class="review_text"></blockquote>
                            </div>
                            <div class = 'round'>
                                <img class="review_picture">
                                <div class="name_box">
                                    <figcaption class="review_name"></figcaption>
                    ...
                    <template id="reviewBig">
                        <div class="review_big">
                            <div class = "review_big_wrapper">
                                <div class = 'review_big_btn'><a href="#">x</a></div>
                                <div class="row review_big_single">
                                    <div class = 'round review_big_single_pic col4'>
                                        <img class="review_big_single_pic_wrapped">
                                    </div>   
                                    <div class="review_big_single_box col8">
                                        <figcaption class="review_big_single_box_name"></figcaption>
                                        <p class="review_big_single_box_date"></p>
                                        <p class="review_big_single_box_text"></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="glider row" id="review_row"></div>
                    <div class="row ">
                        <button aria-label="Previous" class="glider-prev">«</button>
                        <button aria-label="Next" class="glider-next">»</button>
                    </div>
                    <div class="row review_footer">    
                        <div role="tablist" class="col12 dots"></div>   
                    </div>
                    <div class="open review_btn">
                        <a href="#">+</a> 
                    </div>
                </div>
                ...
                <div class="row hidden" id="review_container">
                    <form class='col12 closed' id="review_form">
                        ...
                        <div><textarea id="review_text" name="review_text" placeholder='Atsauksme*' required></textarea></div>
                        <div><button class="button" id="upload_button">Pievienot profila attēlu</button></div>
                        <div><input type="file" id="profile_picture" style="display:none"></div> 
                ...
                <div class="row">
                    <div class="col4 center">
                        <svg 
                            ...
                            width="85" 
                            height="100">                             
                            <use xlink:href="img/defs.svg#HTML5"></use> 
                        </svg>
                    ...
                    <div class="col4 center">
                        <svg
                            ...
                            width="85"
                            height="100">
                            <use xlink:href="img/defs.svg#CSS3"></use>
                        </svg>
                    ...
                    <div class="col4 center">
                        <svg             
                            ...
                            height="100" 
                            viewBox="0 0 128 100">
                            <use xlink:href="img/defs.svg#SASS"></use>
                        </svg>
                    ...
                    <div class="col4 center">
                        <svg             
                            ...
                            height="100" 
                            viewBox="0 0 97 100">                         
                            <use xlink:href="img/defs.svg#JS"></use>
                        </svg>
                    ...
                    <div class="col4 center">
                        <svg             
                            ...
                            height="100" 
                            viewBox="0 0 97 100">                         
                            <use xlink:href="img/defs.svg#BS"></use>
                        </svg> 
                    ...
                    <div class="col4 center">
                        <svg             
                            ...
                            height="100"
                            viewBox="0 0 48 48">                         
                            <use xlink:href="img/defs.svg#GIT"></use>
                        </svg> 
                    ...
                    <div class="col4 center">
                        <svg             
                            ...
                            height="100" 
                            viewBox="0 0 70 100">                         
                            <use xlink:href="img/defs.svg#FIGMA"></use>
                        </svg> 
                ...
                <div class="row">
                    <div class="col4 center">
                        <svg 
                            ...
                            width="100px" 
                            height="100px">                         
                            <use xlink:href="img/defs.svg#nodejs"></use>
                        </svg>  
                ...
                <div class="row footer_icons">
                    <div class="col3">    
                        <a href="https://www.linkedin.com/in/filips-babris-6a254b111/">
                            <svg viewBox="0 0 30 31" width="30px" height="30px">
                                <use xlink:href="img/defs.svg#linkedin"></use>
                            </svg>
                        </a> 
                    </div>
                    ...
                    <div class="col3">           
                        <a href="mailto: fbabris2@gmail.com">
                            <svg viewBox="0 0 30 28" height="30px" width="30px">
                                <use xlink:href="img/defs.svg#letter"></use>
                            </svg>
                        </a>
                    </div>
                    ...
                    <div class="col3">            
                        <a href="https://www.instagram.com/fbfilips/">
                            <svg viewBox="0 0 30 30" height="30px" width="30px">
                                <use xlink:href="img/defs.svg#instagramm"></use>
                            </svg>
                        </a>
                    </div>
                    ...
                    <div class="col3">            
                        <a href="https://www.facebook.com/Filips.Babris2/">
                            <svg viewBox="0 0 30 28" height="30px" width="30px">
                                <use xlink:href="img/defs.svg#facebook"></use>
                            </svg>
                        </a> 
                    </div>           
                </div>
